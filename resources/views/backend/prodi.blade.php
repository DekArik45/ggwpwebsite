            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    <button style="float:right;" type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-input">
                        <i class="fa fa-plus"></i> Add New Prodi
                    </button>
                </div>
                <div class="box-body">
                        ...
                        <tbody>
                            @foreach ($prodi as $item)
                                <tr class="data-row">
                                    ...
                                    <td class="prodi">{{ $item->nama_prodi }}</td>
                                    <td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Add New Prodi</h4>
            </div>
            <form action="/admin/prodi" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="prodi" class="form-control" placeholder="Nama Prodi" />
                    </div>
                ...
                <form id="edit-form"  method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="prodi" class="form-control" id="modal-edit-prodi" required autofocus>
                        </div>
                    </div>
                    <div class="modal-footer">
...
$(document).ready(function() {
    ...
    */
    ...
    $('#modal-default').on('show.bs.modal', function() {
        ...
        var prodi = row.children(".prodi").text();
        $("#edit-form").attr('action', '/admin/prodi/'+id);
