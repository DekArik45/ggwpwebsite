    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <table style="margin-top:10px;" id="jabatan" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                <th>No.</th>
                                <th>Jabatan</th>
                        ...
                        <tbody>
                            @foreach ($jabatan as $item)
                                <tr class="data-row">
                                    ...
                                    <td class="jabatan">{{ $item->nama_jabatan }}</td>
                                    <td>
                                        <button type="button" id="edit-item" data-item-id="{{$item->id}}" class="btn btn-warning" title="Edit">
                                            <i class="fa fa-pencil-square-o"></i>
                                        </button>
                                        <form action="/admin/jabatan/{{$item->id}}" method="POST" id="form_delete" class="btn-group">
                                            @csrf
                                            @method("DELETE")
                ...
                <form id="edit-form"  method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="jabatan" class="form-control" id="modal-edit-jabatan" required autofocus>
                        </div>
                    </div>
                    <div class="modal-footer">
